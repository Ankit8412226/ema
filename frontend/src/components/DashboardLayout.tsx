...
import { BellIcon, BookOpenIcon, BuildingStorefrontIcon, ChartBarIcon, ClipboardDocumentListIcon, Cog6ToothIcon, ExclamationTriangleIcon, HomeIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
